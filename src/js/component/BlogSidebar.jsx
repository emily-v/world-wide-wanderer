	...
	return (
		<div>
			<div className="pt-5 pb-3 px-md-1 px-lg-3 text-center sidebarContentContainer">
				<img
					src="https://my-first-wordpress-emilyv.c9users.io/wp-content/uploads/2018/08/Emily-pic-e1534537576902.jpg"
					alt="Emily-pic"
					className="img-fluid rounded-circle mt-2 mb-3 mr-md-1"
					width="100"
				/>
				<img
					src="https://my-first-wordpress-emilyv.c9users.io/wp-content/uploads/2018/08/Keshaunda-pic-e1534539578333.jpg"
					alt="KeShaunda-pic"
					className="img-fluid rounded-circle mt-2 mb-3 ml-md-1"
					width="100"
				/>
				<p>
					<span className="font-weight-bold">Hello world! </span>
					We are Emily Vong and KeShaunda Parrish, new full-stack web
					developers in Miami, Florida. This project blends together
					components that lay the groundwork for each of our
					personal-professional interests while gaining skills and
					confidence for future career endeavors. We hope you enjoy
					the site!
				</p>
				{/*-----BEGIN ARCHIVES-----*/}
				...
				<div className="mt-5 mb-3 socials">
					...
					<ul className="font-weight-bold list-inline d-flex justify-content-around px-5">
						...
						<li className="list-inline-item h2">
							<a
								href="https://github.com/emily-v/final-project-emily-keshaunda"
								className="text-dark"
								target="_blank"
								rel="noopener noreferrer">
