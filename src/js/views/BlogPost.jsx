        ...
        return (
            <div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-12 col-md-9 border-right postContentContainer">
                            <h1 className="text-center my-3 postTitle">This is the Title of an Individual Blog Post</h1>
                            ...
                            <div className="row postImageContainer">
                                <div className="col-md-6">
                                    <img src="http://via.placeholder.com/500x350" alt="post featured image" className="img-fluid pb-3"/>
                                </div>
                                <div className="col-md-6">
                                    <img src="http://via.placeholder.com/500x350" alt="post featured image" className="img-fluid pb-3"/>
                                </div>
