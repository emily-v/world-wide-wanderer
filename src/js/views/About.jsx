							...
							<div className="row justify-content-center">
								<div className="col-12 col-sm-6 col-lg-5 col-xl-4 text-center px-md-5 mb-5 mb-sm-0 d-flex flex-column">
									<img
										...
										src="https://my-first-wordpress-emilyv.c9users.io/wp-content/uploads/2018/08/KeShaunda-bio-pic-e1534687592272.jpg"
									/>
									<h5 className="mt-3">KeShaunda Parrish</h5>
									<p className="">
										I began my journey into development out
										of a want and need to pivot careers. For
										many years I&apos;ve been walking the
										line between being a creative business
										woman all the while working a 9-5. I
										wanted a career that would fulfill my
										need to create and decided to jump head
										on into UX/UI and Front End Development.
										In the last 3 months I&apos;ve been
										frustrated, nervous, and excited all at
										the same time. This has truly been a
										journey but we have made it to the final
										project. The melding of two ideas
										brought to life.
									</p>
								...
								<div className="col col-sm-6 col-lg-5 col-xl-4 text-center px-md-5 d-flex flex-column">
									<img
										className="img-fluid rounded-circle d-block mx-auto"
										src="https://my-first-wordpress-emilyv.c9users.io/wp-content/uploads/2018/08/Emily-bio-pic-e1534688048665.jpg"
									/>
									...
									<p className="">
										...
										new direction. As a new web developer I
										am excited by the opportunity to use
									...
									<ul className="font-weight-bold list-inline d-flex justify-content-around mt-auto px-5">
										<li className="list-inline-item h2">
											<a
												href="https://www.facebook.com/emily.vong25"
												className="text-dark"
												target="_blank"
												rel="noopener noreferrer">
												<FontAwesomeIcon
