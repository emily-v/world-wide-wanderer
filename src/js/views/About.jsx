                        ...
                        <div className="col">
                            <div className="row justify-content-center">
                                <div className="col-12 col-sm-6 col-lg-5 col-xl-4 text-center px-md-5 mb-5 mb-sm-0 d-flex flex-column">
                                    <img className="img-fluid rounded-circle d-block mx-auto" src="https://via.placeholder.com/200x250" />
                                ...
                                <div className="col col-sm-6 col-lg-5 col-xl-4 text-center px-md-5 d-flex flex-column">
                                    <img className="img-fluid rounded-circle d-block mx-auto" src="https://my-first-wordpress-emilyv.c9users.io/wp-content/uploads/2018/08/Emily-pic-e1534537576902.jpg" />
